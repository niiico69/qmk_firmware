...
#define _________________ADJUST_R3_________________        KC_NO,   TO(_AZERTY_BEPO), TO(_BEPO), TO(_BEPO_MAC), KC_NO
...
#define ___________________NAV_L3__________________        DT_DOWN, TO(_AZERTY_BEPO), TO(_BEPO), TO(_BEPO_MAC), KC_PAUS
